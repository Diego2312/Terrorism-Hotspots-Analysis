...
df = pd.read_csv(r"C:\Users\Owner\ACSAI\Extra\Terrorism-Hotspots-Analysis\datasets (1)\datasets\globalterrorismdb_0718dist.tar.bz2", compression="bz2", usecols=[ 'eventid', 'iyear', 'imonth', 'iday', 'country', 'region', 'city', 'summary', 'success','suicide', 'attacktype1', 'attacktype1_txt', 'targtype1', 'targtype1_txt', 'natlty1', 'natlty1_txt', 'gname', 'nkill', 'nperps', 'nkillus', 'weaptype1', 'weapsubtype1'])
filtered_df = df[df['iyear'] > 1985]
